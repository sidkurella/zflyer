...
pub fn build(b: *std.Build) void {
    ...
    const zigzag_module = b.createModule(.{
        .root_source_file = zigzag_dep.path("src/root.zig"),
        .target = target,
        .optimize = optimize,
    });
    const dotenv_module = b.createModule(.{
        .root_source_file = dotenv_dep.path("src/root.zig"),
        .target = target,
        .optimize = optimize,
    });
